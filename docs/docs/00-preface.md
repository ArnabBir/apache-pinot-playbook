...
```mermaid
flowchart LR
    A["<b>01 · LEARN</b><br/>docs/<br/><small>25 chapters and visual models</small>"]
    B["<b>02 · DEFINE</b><br/>schemas · tables · contracts<br/><small>Data shape and serving behavior</small>"]
    C["<b>03 · EXECUTE</b><br/>scripts · SQL · jobs<br/><small>Generate, ingest, query, measure</small>"]
    D["<b>04 · OPERATE</b><br/>src · app · Docker Compose<br/><small>Run the complete local platform</small>"]

    A -->|turn concepts into choices| B
    B -->|make choices observable| C
    C -->|exercise the system| D
    D -. validate and refine .-> A

    classDef learn fill:#e8edfa,stroke:#657ea9,stroke-width:2px,color:#101b35
    classDef define fill:#fff0d7,stroke:#bb7f28,stroke-width:2px,color:#412600
    classDef execute fill:#ddf4ee,stroke:#25806d,stroke-width:2px,color:#103b32
    classDef operate fill:#f0eaff,stroke:#7455bd,stroke-width:2px,color:#2f1c61
    class A learn
    class B define
    class C execute
    class D operate
